...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="Infor">
        <h3>Mua hàng</h3>
        <asp:TextBox ID="txtFullname" runat="server" Placeholder="Họ tên" CssClass="form-control" />
        ...
        <asp:TextBox ID="txtCity" runat="server" CssClass="form-control" Placeholder="Thành phố"></asp:TextBox>
        <asp:TextBox ID="txtNote" runat="server" CssClass="form-control" Placeholder="Ghi chú"></asp:TextBox>
        <asp:Button ID="btnSubmit" runat="server" CssClass="Submit" Text="Gửi đơn hàng" OnClick="btnSubmit_Click" />
    </div>
</div>
</asp:Content>
