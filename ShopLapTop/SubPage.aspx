...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="new-products">
        ...
        <asp:Button ID="LoadMoreMongNhe" runat="server" Text="Xem thêm" CssClass="load-more-btn" OnClick="LoadMoreMongNhe_Click" />
    </div>
    ...
    <div class="new-products">
        ...
        <asp:Button ID="LoadMoreGaming" runat="server" Text="Xem thêm" CssClass="load-more-btn" OnClick="LoadMoreGaming_Click" />
    </div>
    ...
    <div class="new-products">
        ...
        <asp:Button ID="LoadMoreMacbook" runat="server" Text="Xem thêm" CssClass="load-more-btn" OnClick="LoadMoreMacbook_Click" />
    </div>
    ...
    <div class="new-products">
        ...
        <asp:Button ID="LoadMoreCaoCap" runat="server" Text="Xem thêm" CssClass="load-more-btn" OnClick="LoadMoreCaoCap_Click" />
    </div>
</asp:Content>
