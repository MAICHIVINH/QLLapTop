...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container">
        ...
        <asp:Button ID="btnDeleteProduct" runat="server" Text="DeleteProduct" OnClientClick="return confirm('Bạn có muốn xóa Sản Phẩm này không?')" OnClick="btnDeleteProduct_Click" />
    </div>
