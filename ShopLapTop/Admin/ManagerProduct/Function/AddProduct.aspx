...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Button ID="btnHomeProduct" runat="server" Text="Tro lai trang chu" OnClick="btnHomeProduct_Click" Visible="False" />
    <div class="container">
        ...
        <div class="input-group mb-3">
            <span class="input-group-text" id="inputGroup-sizing-default">Image Permistion</span>
